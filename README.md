...
> **No NDAs. No sales calls. Just your FPGA, your oscilloscope, and 20 minutes.**

### Step 1 – Request the Pre‑Built Bitstream

Pre‑compiled bitstreams are available **upon request** for qualified partners (government, critical infrastructure, hyperscalers).

📧 **Send a request to:** `totalprotocol@proton.me`  
Subject: *“Bitstream Request – [Your Organization]”*

Please include your Arty A7 board revision (e.g., A7‑100T or A7‑35T) and we will send you the signed `.bit` and `.ltx` files within 24 hours.

### Step 2 – Program the FPGA (after you receive the bitstream)
